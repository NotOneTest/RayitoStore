...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $product1->tags()->attach([1, 2, 3]);
        
        $product2 = Product::find(2);
        $product2->tags()->attach([3, 9, 10]);
        
        $product3 = Product::find(3);
        $product3->tags()->attach([1, 2, 4, 5]);
        
        $product4 = Product::find(4);
        $product4->tags()->attach([3, 9, 10]);
        
        $product5 = Product::find(5);
        $product5->tags()->attach([1, 2, 6]);
        
        $product6 = Product::find(6);
        $product6->tags()->attach([3, 9, 10]);
        
        $product11 = Product::find(11);
        $product11->tags()->attach([1, 2, 7, 5]);
        
        $product14 = Product::find(14);
        $product14->tags()->attach([1, 6, 12]);
        
        $product16 = Product::find(16);
        $product16->tags()->attach([9, 12, 10]);
    }
}
