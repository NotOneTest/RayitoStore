...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Rayito Store - Tu Tienda de Videojuegos'); ?></title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;600;700&family=Rajdhani:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('css/rayito.css')); ?>?v=4">
    <style>
        ...
        <div class="container">
            <div class="header-content">
                ...
                <nav class="nav">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="nav-link">Juegos</a>
                    <a href="<?php echo e(route('forum.index')); ?>" class="nav-link">Foro</a>
                    <a href="<?php echo e(route('info.about')); ?>" class="nav-link">Nosotros</a>
                    <a href="<?php echo e(route('info.contact')); ?>" class="nav-link">Contacto</a>
                </nav>
                ...
                <div class="header-actions">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="user-menu">
                            ...
                            <div class="user-dropdown">
                                ...
                                <a href="<?php echo e(route('checkout.orders')); ?>" class="dropdown-item">Mis Pedidos</a>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="login-btn">Ingresar</a>
                    <?php endif; ?>
                </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="<?php echo e(route('products.index')); ?>">Juegos</a></li>
                        <li><a href="<?php echo e(route('info.about')); ?>">Sobre Nosotros</a></li>
                        <li><a href="<?php echo e(route('info.contact')); ?>">Contacto</a></li>
                    </ul>
                </div>
                <div class="footer-section">
                    <h4 class="footer-subtitle">Categorías</h4>
                    <ul class="footer-links">
                        <li><a href="<?php echo e(route('products.index', ['category' => 'accion'])); ?>">Acción</a></li>
                        <li><a href="<?php echo e(route('products.index', ['category' => 'aventura'])); ?>">Aventura</a></li>
                        <li><a href="<?php echo e(route('products.index', ['category' => 'rpg'])); ?>">RPG</a></li>
                        <li><a href="<?php echo e(route('products.index', ['category' => 'shooter'])); ?>">Shooter</a></li>
                    </ul>
                </div>
                <div class="footer-section">
...
<?php /**PATH C:\laragon\www\proyecto_negocios_electronicos\resources\views/layouts/app.blade.php ENDPATH**/ ?>